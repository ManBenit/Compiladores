...
public class autobool{
	public static void main(String[] args) {
		...
		try {
			...
			reader = new BufferedReader(new FileReader("/Users/Jessy/Desktop/grambienprueba.txt"));
			writer = new BufferedWriter(new FileWriter("/Users/Jessy/Desktop/AccionSemantica.java"));
